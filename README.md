...
I am a driven software engineer with a strong foundation in modern web development and a deep passion for Artificial Intelligence. I don't just write code—I build products that deliver tangible business value and exceptional user experiences.

- 🚀 **Currently Building:** **Wispa Ai** (Supported by the SSIP Govt. of India).
- 💼 **Entrepreneurship:** Founder & Developer at **Forb Tech Solutions**.
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=react,ts,js,nodejs,php,mysql,html,css,git,github,vscode,figma&theme=light&perline=12" />
</div>

---

## 🚀 Featured Deployments & Client Work

| Project / Client | Description & Impact | Live Link |
| :--- | :--- | :--- |
| **Forb Tech Solutions** | Enterprise solutions architecture & deployment. | [View Project](https://forb-tech-solutions.vercel.app/) |
| **Smart City Portal** | Civic issue tracking. *Reduced resolution time by 30%.* | *(Internal/Private)* |
| **Anaya Dental Care** | Digital healthcare presence and appointment booking. | [View Project](https://anaya-dental-care.vercel.app/) |
| **Dev's Kitchen** | Modern restaurant UI and dynamic menus. | [View Project](https://dev-munjani.github.io/Dev-s-Kitchen/) |
| **Hardcore Nikol** | E-commerce/Client landing page. | [View Project](https://hardcore-nikol.vercel.app/) |
| **Banti Kaka Bhavnagari** | Interactive local business platform. | [View Project](https://buntykakabhavnagari.github.io/Banti-Kaka-Bhavnagari-Bateta-Bhungla/) |
