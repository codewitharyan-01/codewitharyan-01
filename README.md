...
| :--- | :--- | :--- |
| 🏙️ **Smart City Citizen Portal** | Full-stack civic issue reporting platform. <br>✅ *Reduced issue resolution time by 30%* | `PHP`, `MySQL`, `HTML/CSS` |
| 🏋️‍♂️ **Life Fitness Membership** | Gym Management platform w/ real-time tracking. <br>✅ *Improved daily operational efficiency* | `PHP`, `MySQL`, `JS` |
